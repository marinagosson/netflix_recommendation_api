...
movieVectorRoutes.get("/count", movieVectorController.count);
movieVectorRoutes.get("/clear", movieVectorController.clear);
movieVectorRoutes.post("/search", movieVectorController.search);
